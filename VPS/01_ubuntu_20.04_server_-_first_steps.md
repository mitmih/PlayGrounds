...
# Первоначальная настройка сервера на Ubuntu 20.04

Проверено на [vps этого хостинга](https://vdsina.ru/?partner=yfr2sd6574)
...
## Шаг 1 - Подготовка SSH-ключей, установка виртуального сервера
...
## Шаг 4 - включаем ssh-доступ для нового пользователя
